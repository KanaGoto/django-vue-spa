        ...
        this.createAddress(addData)
          ...
          .then(function() {
            ...
            self.cartItems.forEach(item => {
              ...
              detailData.append("item", item.item.id);
              detailData.append("amount", item.amount);
              detailData.append(
                "total_price",
                item.item.shop_price * item.amount
              );
              self.createOrderDetail(detailData).then(function(res) {
          ...
          .then(function() {
            ...
            self
              ...
              .then(
                function() {
                  self.getCartItems(self.userInfo.user_id);
                }.then(function() {
                  alert(self.orderInfo.orderDetail[0]);
                  alert(self.orderInfo.orderDetail[1]);
